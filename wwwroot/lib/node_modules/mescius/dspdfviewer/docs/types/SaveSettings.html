...
<div class="tsd-signature">Save<wbr/>Settings<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>format<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;PDF&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;PNG&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;SVG&quot;</span><span class="tsd-signature-symbol">; </span>pages<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>progressMessage<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>progressTitle<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>reload<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>saveMode<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;Auto&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;Default&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;Linearized&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;IncrementalUpdate&quot;</span><span class="tsd-signature-symbol">; </span>sign<span class="tsd-signature-symbol">?: </span><a href="SignatureInfo.html" class="tsd-signature-type" data-tsd-kind="Type alias">SignatureInfo</a><span class="tsd-signature-symbol">; </span>zoomFactor<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span></div>
...
<h5><code class="tsd-tag ts-flagOptional">Optional</code> format<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;PDF&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;PNG&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;SVG&quot;</span></h5>
...
SVG - the document will be saved to SVG images.</p>

<h3>Default</h3><p>PDF.</p>

<h3>Example</h3><p>Save the document as SVG images</p>
<pre><code class="language-javascript"><span class="hl-7">await</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-3">save</span><span class="hl-1">(</span><span class="hl-4">&quot;sample.zip&quot;</span><span class="hl-1">, { </span><span class="hl-2">format:</span><span class="hl-1"> </span><span class="hl-4">&quot;SVG&quot;</span><span class="hl-1"> });</span>
</code></pre>

<h3>Example</h3><p>Save document pages as PNG images</p>
<pre><code class="language-javascript"><span class="hl-7">await</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-3">save</span><span class="hl-1">(</span><span class="hl-4">&quot;sample.zip&quot;</span><span class="hl-1">, { </span><span class="hl-2">format:</span><span class="hl-1"> </span><span class="hl-4">&quot;SVG&quot;</span><span class="hl-1"> });</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
