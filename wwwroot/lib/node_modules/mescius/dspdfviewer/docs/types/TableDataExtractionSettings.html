<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>TableDataExtractionSettings | Document Solutions PDF Viewer - v8.0.0</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v8.0.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="TableDataExtractionSettings.html">TableDataExtractionSettings</a></li></ul>
<h1>Type alias TableDataExtractionSettings</h1></div>
<div class="tsd-signature">Table<wbr/>Data<wbr/>Extraction<wbr/>Settings<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>allowedExportFormats<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">TableDataExportFormat</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">; </span>extractOptions<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">ClientTableExtractOptions</span><span class="tsd-signature-symbol">; </span>title<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Configuration options for the Table Data Extraction dialog.</p>
<p>This type defines the settings that can be customized for the dialog, including the title and allowed export formats.</p>
</div>
<div class="tsd-type-declaration">
<h4>Type declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> allowed<wbr/>Export<wbr/>Formats<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">TableDataExportFormat</span><span class="tsd-signature-symbol">[]</span></h5>
<div class="tsd-comment tsd-typography"><p>List of export formats allowed for the table data extraction.</p>
<p>This specifies the formats (e.g., CSV, JSON, XLSX, XML, HTML) in which the extracted table data can be exported.</p>

<h3>Default</h3><p>[&#39;csv&#39;, &#39;json&#39;, &#39;xlsx&#39;, &#39;xml&#39;, &#39;html&#39;]</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">tableDataExtraction</span><span class="hl-1"> = {</span><br/><span class="hl-1">    </span><span class="hl-2">allowedExportFormats:</span><span class="hl-1"> [</span><span class="hl-4">&#39;csv&#39;</span><span class="hl-1">, </span><span class="hl-4">&#39;json&#39;</span><span class="hl-1">]</span><br/><span class="hl-1">};</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> extract<wbr/>Options<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">ClientTableExtractOptions</span></h5>
<div class="tsd-comment tsd-typography"><p>Options related to table extraction, passed from the client.</p>
<p>This property allows configuring various parameters for table extraction, such as precision, tokenization, and other settings.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">tableDataExtraction</span><span class="hl-1"> = {</span><br/><span class="hl-1">    </span><span class="hl-2">extractOptions:</span><span class="hl-1"> {</span><br/><span class="hl-1">        </span><span class="hl-2">CoefPrecision:</span><span class="hl-1"> </span><span class="hl-8">0.3</span><span class="hl-1">,</span><br/><span class="hl-1">        </span><span class="hl-2">CoefTokenization:</span><span class="hl-1"> </span><span class="hl-8">0.1</span><br/><span class="hl-1">    }</span><br/><span class="hl-1">};</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>The title of the Table Data Extraction dialog.</p>
<p>This title will be displayed at the top of the dialog window.</p>

<h3>Default</h3><p>&#39;Table Data Extraction&#39;</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">tableDataExtraction</span><span class="hl-1"> = {</span><br/><span class="hl-1">    </span><span class="hl-2">title:</span><span class="hl-1"> </span><span class="hl-4">&#39;Custom Dialog Title&#39;</span><br/><span class="hl-1">};</span>
</code></pre>
</div></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="TableDataExtractionSettings.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Table<wbr/>Data<wbr/>Extraction<wbr/>Settings</a></li>
