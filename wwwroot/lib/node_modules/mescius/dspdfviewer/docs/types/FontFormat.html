<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>FontFormat | Document Solutions PDF Viewer - v8.0.0</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v8.0.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="FontFormat.html">FontFormat</a></li></ul>
<h1>Type alias FontFormat</h1></div>
<div class="tsd-signature">Font<wbr/>Format<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">&quot;truetype&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;opentype&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;woff&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;woff2&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;ttc&quot;</span></div>
<div class="tsd-comment tsd-typography"><p>Specifies the font format.</p>
<ul>
<li><code>&quot;truetype&quot;</code>: TrueType Font (TTF).</li>
<li><code>&quot;opentype&quot;</code>: OpenType Font (OTF).</li>
<li><code>&quot;woff&quot;</code>: Web Open Font Format (WOFF).</li>
<li><code>&quot;woff2&quot;</code>: Web Open Font Format 2 (WOFF2). Not supported by the Wasm version of the SupportApi.</li>
<li><code>&quot;ttc&quot;</code>: TrueType Collection (TTC). This format is for fallback fonts only; see the <a href="../classes/DsPdfViewer.html#registerFallbackFont">registerFallbackFont</a> method for details.</li>
</ul>
</div></div>
...
<li class="current tsd-kind-type-alias"><a href="FontFormat.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Font<wbr/>Format</a></li>
