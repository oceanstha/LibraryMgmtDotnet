<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>ReplaceTextSettings | Document Solutions PDF Viewer - v8.0.0</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v8.0.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="ReplaceTextSettings.html">ReplaceTextSettings</a></li></ul>
<h1>Type alias ReplaceTextSettings</h1></div>
<div class="tsd-signature">Replace<wbr/>Text<wbr/>Settings<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>title<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Replace Text dialog settings.</p>
</div>
...
<h3>Default</h3><p>&#39;Replace Text&#39;</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-1">      </span><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">replaceText</span><span class="hl-1"> = {</span><br/><span class="hl-1">            </span><span class="hl-2">title:</span><span class="hl-1"> </span><span class="hl-4">&#39;Replace text in document&#39;</span><br/><span class="hl-1">      };</span>
</code></pre>
</div></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="ReplaceTextSettings.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Replace<wbr/>Text<wbr/>Settings</a></li>
