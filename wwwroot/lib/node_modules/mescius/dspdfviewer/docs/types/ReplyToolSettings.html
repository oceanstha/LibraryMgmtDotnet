<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>ReplyToolSettings | Document Solutions PDF Viewer - v8.0.0</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v8.0.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<div class="tsd-comment tsd-typography"><p>Allows adding notes.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allows adding replies.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allows adding replies to notes created by other users.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allows modifying notes created by other users.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allows changing the user name.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allows deleting notes or replies.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allows deleting notes or replies created by other users.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allows setting a status on notes or replies.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allows setting a status on notes or replies created by other users.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Defines the color used for temporarily highlighting an annotation on the PDF page
when it is selected in the comments list within the Reply Tool.</p>

<h3>Property</h3><p>The highlight color in hex format.
  This setting is also utilized in the <code>showAnnotationFocusOutline</code> method if the
  color parameter is not explicitly specified.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#root&quot;</span><span class="hl-1">, { </span><span class="hl-2">replyTool:</span><span class="hl-1"> { </span><span class="hl-2">annotationFocusColor:</span><span class="hl-1"> </span><span class="hl-4">&quot;blue&quot;</span><span class="hl-1"> } });</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
...
<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Disable automatic expansion of the Reply Tool.</span><br/><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#root&quot;</span><span class="hl-1">, { </span><span class="hl-2">replyTool:</span><span class="hl-1"> { </span><span class="hl-2">autoExpandOnCommentAdd:</span><span class="hl-1"> </span><span class="hl-0">false</span><span class="hl-1"> } });</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> date<wbr/>Format<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>Specifies the custom format for absolute dates in comment headers.</p>

<h3>Property</h3><p>HH:MM&quot;] - The format to use when displaying absolute dates.
  Ignored if <code>useRelativeDates</code> is <code>true</code>.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Use a custom format for absolute dates.</span><br/><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#root&quot;</span><span class="hl-1">, { </span><span class="hl-2">replyTool:</span><span class="hl-1"> { </span><span class="hl-2">useRelativeDates:</span><span class="hl-1"> </span><span class="hl-0">false</span><span class="hl-1">, </span><span class="hl-2">dateFormat:</span><span class="hl-1"> </span><span class="hl-4">&quot;dd.mm.yyyy HH:MM&quot;</span><span class="hl-1"> } });</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Enables read-only mode, preventing any modifications.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>If set to <code>true</code>, comment icons will be filled with the color used in the annotation.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> use<wbr/>Relative<wbr/>Dates<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>Enables the use of relative dates in comment headers.</p>

<h3>Property</h3><p><code>true</code>: Displays relative dates (e.g., &quot;5 minutes ago&quot;).</p>
<ul>
<li><code>false</code>: Displays absolute dates instead.</li>
</ul>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Enable relative dates (default behavior).</span><br/><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#root&quot;</span><span class="hl-1">, { </span><span class="hl-2">replyTool:</span><span class="hl-1"> { </span><span class="hl-2">useRelativeDates:</span><span class="hl-1"> </span><span class="hl-0">true</span><span class="hl-1"> } });</span><br/><br/><span class="hl-5">// Disable relative dates.</span><br/><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#root&quot;</span><span class="hl-1">, { </span><span class="hl-2">replyTool:</span><span class="hl-1"> { </span><span class="hl-2">useRelativeDates:</span><span class="hl-1"> </span><span class="hl-0">false</span><span class="hl-1"> } });</span>
</code></pre>
</div></li></ul></div></div>
...
<li class="tsd-kind-type-alias"><a href="FontFormat.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Font<wbr/>Format</a></li>
...
<li class="tsd-kind-class"><a href="../classes/ReplaceTextAnnotation.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-128-path"></use><use href="#icon-128-text"></use></svg>Replace<wbr/>Text<wbr/>Annotation</a></li>
<li class="tsd-kind-type-alias"><a href="ReplaceTextModel.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Replace<wbr/>Text<wbr/>Model</a></li>
<li class="tsd-kind-type-alias"><a href="ReplaceTextSettings.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Replace<wbr/>Text<wbr/>Settings</a></li>
...
<li class="tsd-kind-type-alias"><a href="SelectedTextCoordinates.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Selected<wbr/>Text<wbr/>Coordinates</a></li>
...
<li class="tsd-kind-type-alias"><a href="TableDataExtractionModel.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Table<wbr/>Data<wbr/>Extraction<wbr/>Model</a></li>
<li class="tsd-kind-type-alias"><a href="TableDataExtractionSettings.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Table<wbr/>Data<wbr/>Extraction<wbr/>Settings</a></li>
