<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>ViewerPreferences | Document Solutions PDF Viewer - v8.0.0</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v8.0.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<div class="tsd-comment tsd-typography"><p>A name object specifying the page layout shall be used when the document is opened.
The following pageLayout values specified in the PDF document correspond to the pageDisplay values in the viewer:</p>
<ul>
<li>TwoColumnLeft: This sets pageDisplay to TwoPageScrolling.</li>
<li>TwoColumnRight: This sets pageDisplay to TwoPageScrolling.</li>
<li>TwoPageLeft: This sets pageDisplay to TwoPage.</li>
<li>TwoPageRight: This sets pageDisplay to TwoPage.</li>
<li>OneColumn: This sets pageDisplay to SinglePageScrolling.</li>
<li>SinglePage: This sets pageDisplay to SinglePage.</li>
</ul>
</div></li>
<li class="tsd-parameter">
