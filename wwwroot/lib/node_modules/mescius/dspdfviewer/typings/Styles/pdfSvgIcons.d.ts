...
export declare const pdfSvgIcons: {
    ...
    'noaccent-checkbox-checked': React.JSX.Element;
    'noaccent-checkbox-unchecked': React.JSX.Element;
    ...
    'edit-replace-text': React.JSX.Element;
    'replace-next': React.JSX.Element;
    'replace-all': React.JSX.Element;
    ...
    'extract-table-data': React.JSX.Element;
    ...
    'pagedisplay-singlepage': React.JSX.Element;
    'pagedisplay-singlepagescrolling': React.JSX.Element;
    'pagedisplay-twopage': React.JSX.Element;
    'pagedisplay-twopagescrolling': React.JSX.Element;
    'pagedisplay-check2': React.JSX.Element;
};
