...
import { OpenParameters, OptionalContentConfig, PageViewport, SaveSettings, StructTreeNode, ViewerFeatureName, ViewerPreferences, IGCEventBus, DocumentListItem, SubmitFormOptions, ScrollPageIntoViewOptions, IGcPageView, FontFormat, ReplaceTextModel } from './Models/ViewerTypes';
...
export declare class GcPdfViewer extends ReportViewer {
    ...
    getType(typeName: string): typeof React | typeof AnnotationBase | typeof GcPdfViewer | typeof ReactDOM | typeof AsyncLock | typeof PdfReportPlugin | typeof AnnotationTypeCode | typeof ViewMode | typeof utf8ToBase64 | typeof PromiseQueue | typeof EditMode | typeof GenericButton | typeof ViewerStatus | typeof ViewerOptions | typeof LayoutMode | typeof Toolbar | typeof ZoomMode | typeof GcMeasurement | typeof GcPdfSearcher | typeof GcRightSidebar | null;
    ...
    showTableDataExtraction(): TableDataExtractionDialog;
    ...
    registeredFonts: {
        [fontName: string]: {
            url: string;
            format: FontFormat | undefined;
            clientOnly?: boolean;
            resolved?: boolean;
        };
    };
    private _preloadFont;
    isFontUrlRegistered(url: any): boolean;
    registerFallbackFont(fontNameOrUrl: string, url?: string, args?: FontFormat | {
        format?: FontFormat;
        displayName?: string;
        clientOnly?: boolean;
    }): void;
    registerFont(fontNameOrUrl: string, url?: string, args?: FontFormat | {
        format?: FontFormat;
        displayName?: string;
        addToUI?: boolean;
        clientOnly?: boolean;
    ...
    getModifiedFilesIds(args: {
        documentModification: any;
        saveSettings?: SaveSettings;
        includeFonts?: "All" | "None";
    }): Promise<string[]>;
    ...
    get highlightManager(): ITextHighlightManager;
    applyOptions(): void;
    get language(): string;
    ...
    applyViewPortScale(rectOrCoords: IGcRect | [number, number, number, number] | number[], pageIndex: number, srcOrigin?: "BottomLeft" | "TopLeft"): IGcRect | [number, number, number, number];
